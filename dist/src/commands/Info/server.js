        ...
        if (msg.guild.available) {
            ...
            switch (msg.guild.verificationLevel) {
                case `NONE`:
                    ...
                    break;
                case `LOW`:
                    verificationLevel = `Low: Must have a verified e-mail on their Discord account`;
                    break;
                case `MEDIUM`:
                    verificationLevel = `Medium: Must have a verified e-mail and be registreder for longer than 5 minutes`;
                    break;
                case `HIGH`:
                    verificationLevel = `(╯°□°）╯︵ ┻━┻: Must be in the server for longer than 10 minutes`;
                    break;
                case `VERY_HIGH`:
                    verificationLevel = `┻━┻ ﾐヽ(ಠ益ಠ)ノ彡┻━┻: Must have a phone on their discord account`;
                    break;
            }
            let afkchannelname;
            let afkTimeout;
