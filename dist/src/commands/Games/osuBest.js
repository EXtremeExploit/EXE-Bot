    ...
    constructor(client, msg) {
        ...
        osuApi.getUserBest({
            ...
            msg.channel.send(new discord.MessageEmbed()
                ...
                .setColor([255, 58, 255])
                .addField(`Map`, `**Name:** [${bm.artist} - ${bm.title} [${bm.version}]](https://osu.ppy.sh/s/${bm.beatmapSetId})\n` +
                `**BPM:** ${bm.bpm}\n` +
                `**ID:** ${bm.id}\n` +
                ...
                .addField(`Count Notes`, `**300:** ${play.counts[300]}\n` +
                `**100:** ${play.counts[100]}\n` +
                `**50:** ${play.counts[50]}\n` +
                `**Misses:** ${play.counts.miss}`, true)
                .addField(`Date`, convertDate(date), true)
                .addField(`Links`, `[**Download**](https://osu.ppy.sh/d/${bm.beatmapSetId})([no vid](https://osu.ppy.sh/d/${bm.beatmapSetId}))\n` +
