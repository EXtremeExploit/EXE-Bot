...
import { CoinflipResults, SocialModel, Badges, createProfile, SocialCheckUndefineds } from '../../util.js';
...
export default class {
    constructor(client, msg) {
        SocialModel.findOne({
            ...
            //Coinflipper badges
            if (total >= 1000 && social.badges[Badges.Coinflipper1K] == 0)
                social.badges.set(Badges.Coinflipper1K, 1);
            if (total >= 10000 && social.badges[Badges.Coinflipper10K] == 0)
                social.badges.set(Badges.Coinflipper10K, 1);
            if (total >= 100000 && social.badges[Badges.Coinflipper100K] == 0)
                social.badges.set(Badges.Coinflipper100K, 1);
            if (total >= 1000000 && social.badges[Badges.Coinflipper1M] == 0)
                social.badges.set(Badges.Coinflipper1M, 1);
            //Coinflip Edge badge
            if (social.coinflips.edges >= 1 && social.badges[Badges.CoinflipEdge] == 0)
                social.badges.set(Badges.CoinflipEdge, 1);
            social.save();
        });
    }
    FlipCoin() {
